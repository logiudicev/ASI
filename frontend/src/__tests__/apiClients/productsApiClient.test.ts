...
import {createProduct, getProducts, updateProduct} from "../../components/apiClient/productsApiClient";
...
describe('productsApiClient', () => {
    ...
    describe('updateProduct', () => {
        it('should make a POST request to update a product', async () => {
            const originalProduct = {id: 1, name: 'wrench', quantity: 1};
            const newQuantity = 6;
            ...
            }).post('/products/1', body)
                .reply(200);

            await updateProduct(1, originalProduct, newQuantity)
        })
